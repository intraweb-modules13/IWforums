...
<div class="usercontainer">
    ...
    <form  method="post" name="new_tema" id="new_msg" action="{modurl modname='IWforums' type='user' func='crear_tema'}" enctype="multipart/form-data">
        ...
        <table class="usertable">
            ...
            <tr>
                ...
                <td><input type="text" name="titolmsg" maxlength="80" size="60" value="{$title}"></td>
            </tr>
            <tr>
