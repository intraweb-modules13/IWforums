...
function smarty_function_iwforumsusermenulinks($params, &$smarty)
{
	...
	$access = (isset($params['fid'])) ? ModUtil::func('IWforums', 'user', 'access', array('fid' => $params['fid'])) : false;
	...
	if (SecurityUtil::checkPermission('IWforums::', "::", ACCESS_READ) && isset($params['m5']) && $access > 1) {
	...
	if (SecurityUtil::checkPermission('IWforums::', "::", ACCESS_READ) && isset($params['m1']) && $access > 2 && $params['ftid'] == null) {
	...
	if (SecurityUtil::checkPermission('IWforums::', "::", ACCESS_READ) && isset($params['m2']) && $access > 1) {
		$forumsusermenulinks .= "<a href=\"" . DataUtil::formatForDisplayHTML(ModUtil::url('IWforums', 'user', 'nou_msg',
						array('fid' => $params['fid'],
							'inici' => $params['inici'],
							'u' => $params['u'],
	...
	if (SecurityUtil::checkPermission('IWforums::', "::", ACCESS_READ) && isset($params['m3'])) {
	...
	if (SecurityUtil::checkPermission('IWforums::', "::", ACCESS_READ) && (isset($params['m4']) && $access > 0) || ($params['ftid'] != null && $access >0)) {
	...
	if (SecurityUtil::checkPermission('IWforums::', "::", ACCESS_READ) && isset($params['m7']) && $access > 0) {
		if($params['fmid'] != 0){
	...
	if (SecurityUtil::checkPermission('IWforums::', "::", ACCESS_READ) && isset($params['m8']) && $access > 0) {
	...
	if (SecurityUtil::checkPermission('IWforums::', "::", ACCESS_READ) && isset($params['m9']) && $access > 0 && UserUtil::isLoggedIn()) {
		if ($params['ftid'] == null){
...
/*
	if (SecurityUtil::checkPermission('IWforums::', "::", ACCESS_READ) && isset($params['m10']) && $access > 0) {
		$forumsusermenulinks .= "<a href=\"" . DataUtil::formatForDisplayHTML(ModUtil::url('IWforums', 'user', 'printallmsg',
						array('inici' => $params['inici'],
							'fid' => $params['fid'],
							'ftid' => $params['ftid'],
...
*/
/*
	if (SecurityUtil::checkPermission('IWforums::', "::", ACCESS_READ) && isset($params['m11']) && $access > 0 && UserUtil::isLoggedIn()) {
		$forumsusermenulinks .= "<a onClick=\"javascript:printer()\" style=\"cursor:pointer\">". _FORUMSIMPRIMIRMSG . "</a> " . $params['seperator'];
	}
*/
/*
	if (SecurityUtil::checkPermission('IWforums::', "::", ACCESS_READ) && isset($params['m12']) && $access > 0 && UserUtil::isLoggedIn() && strpos($message['marcat'],'$'.UserUtil::getVar('uid').'$') == 0) {
		$forumsusermenulinks .= "<a href=\"" . DataUtil::formatForDisplayHTML(ModUtil::url('IWforums', 'user', 'marca',
							array('inici' => $params['inici'],
								'm' => 1,
								'fid' => $params['fid'],
								'ftid' => $params['ftid'],
...
*/
/*	
	if (SecurityUtil::checkPermission('IWforums::', "::", ACCESS_READ) && isset($params['m13']) && $access > 0 && UserUtil::isLoggedIn() && strpos($message['marcat'],'$'.UserUtil::getVar('uid').'$') != 0){
		$forumsusermenulinks .= "<a href=\"" . DataUtil::formatForDisplayHTML(ModUtil::url('IWforums', 'user', 'marca',
							array('inici' => $params['inici'],
								'm' => 0,
								'fid' => $params['fid'],
